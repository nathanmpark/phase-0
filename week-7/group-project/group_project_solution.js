...
// Reflections. What passed? What failed?

// None of our tests passed, but the functions actually perform as designed. There was a disconnect in our communication, and the functions were written to take in more than one array as an argument. Thus, each function sum, mean, and median will take two arrays and successfully calculate the sum, mean, and median of two arrays. Had we iterated through and been able to clarify, I have no doubt we would have passed all the tests. I think our team did a great job at communicating and staying connected. We were able to pass off work between our accountability group, the pseudocode was very detailed and followed the user stories, and the coding was well-crafted to match the given pseudocode.